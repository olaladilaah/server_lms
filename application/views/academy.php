    ...
    <div class="bend niceties2 preview-2">
      <div id="ensign-nivoslider" class="slides">
          ...
          <?php foreach($iklan->result() as $key) {?>
             ...
             <img src="<?php echo base_url();?>assets/img/iklan/<?php echo $key->iklan_m_gambar;?>" alt="" title="#slider-direction-1" />
                        ...
                        <div class="container">
                            <div class="btn-group">
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="<?php echo base_url('index.php/c_academyTerlaris');?>">Terlaris</a></li>
                              </ul>
                            </div>
                        </div>
                 </select>
          ...
          <?php foreach($materi->result() as $key) {?>
            ...
            <div class="single-blog" >
              <div class="single-blog-img">
                <a href="<?php echo base_url('index.php/c_detailMateri');?>">
                ...
                <h4>
                   <a href="<?php echo base_url('index.php/c_detailMateri');?>"><?php echo $key->materi_nama;?></a>
		</h4>
                ...
                <table width="100%">
                    ...
                    <tr width="100%">
                        ...
                        <td width="50%" align="right">
                            ...
                            <a href="<?php echo base_url('index.php/c_academy/star');?>"><img src="<?php echo base_url();?>assets/img/icon/star.png" alt="" height="40px" width="40px" style="margin-top: 20px"></a>
                        </td>
